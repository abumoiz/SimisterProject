...
<div>
<img src="trending1.jpg" style={{width:"100%"}}/>
...
<div style={newsPageStyle}>
      <div style={detailedNewsStyle}>
        ...
        <img src="trending2.jpg" style={{marginTop:"20px" , marginBottom:"15px"}}/>
...
Phil Neville returns to MLS with a point to prove, but a fanbase that doesn’t want him</h2>
        <img src="trending3.avif" style={{marginTop:"20px" , marginBottom:"15px" , width:"90%"}}/>
