        ...
        <tbody>
          {logindata.map((details, index) => (
            <tr key={index}>
              ...
              <td>
                 <button style={{width:"90px" , height:"50px" , borderRadius:"15px" , marginLeft:"20px", borderWidth:"5px"}} onClick={() => handleDeleteCustomer(details._id)} >Delete</button>
                <button style={{width:"90px" , height:"50px" , borderRadius:"15px" , marginLeft:"20px", borderWidth:"5px"}} onClick={()=>handleShow(details)}>Update</button> 
              </td>
            </tr>
          ))}
        </tbody>
