...
<Link to="/matchhighlights">
      ...
      <Link to="/dashboard">
      <div>
          <button type="button" style={{ marginLeft: "200px", marginRight: "15px", height: "50px", width: "120px", border: "px solid black", borderRadius: "10px", fontSize: "17px", background: "#F3F6F4" }}>Dashboard</button>
        </div>  
      </Link>
    </nav>
  );
